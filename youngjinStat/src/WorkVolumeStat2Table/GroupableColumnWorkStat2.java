...
//            cm.getColumn(19).setWidth(100);
            ...
            ColumnGroup os = new ColumnGroup("5");
            os.add(cm.getColumn(2));
            os.add(cm.getColumn(3));
            ColumnGroup ot = new ColumnGroup("6");
            ot.add(cm.getColumn(4));
            ot.add(cm.getColumn(5));
            ColumnGroup pyt = new ColumnGroup("T");
            pyt.add(cm.getColumn(6));
            pyt.add(cm.getColumn(7));
            ColumnGroup tdc = new ColumnGroup("HHG other");
            tdc.add(cm.getColumn(8));
            tdc.add(cm.getColumn(9));
            ColumnGroup ujb = new ColumnGroup("HHG TOTAL");
            ujb.add(cm.getColumn(10));
            ujb.add(cm.getColumn(11));
            ColumnGroup tg = new ColumnGroup("7");
            tg.add(cm.getColumn(12));
            tg.add(cm.getColumn(13));
            ColumnGroup bs = new ColumnGroup("8");
            bs.add(cm.getColumn(14));
            bs.add(cm.getColumn(15));
            ColumnGroup ks = new ColumnGroup("J");
            ks.add(cm.getColumn(16));
            ks.add(cm.getColumn(17));
            ColumnGroup other = new ColumnGroup("UB OTHER");
            other.add(cm.getColumn(18));
            other.add(cm.getColumn(19));
            ColumnGroup ubTotal = new ColumnGroup("UB TOTAL");
            ubTotal.add(cm.getColumn(20));
            ubTotal.add(cm.getColumn(21));
            ColumnGroup inTotal = new ColumnGroup("TOTAL");
            inTotal.add(cm.getColumn(22));
            inTotal.add(cm.getColumn(23));
