...
class TablePrintable implements Printable {
    ...
    public int print(Graphics graphics, PageFormat pageFormat, int pageIndex)
        ...
        if (headerText != null) {        	// TODO
        	g2d.translate(0, -hRect.getHeight()/3);
        	 hRect.setRect(hRect.getX(), hRect.getY()-5, hRect.getWidth(), hRect.getHeight());
            printText(g2d, headerText.substring(0,headerText.indexOf("\n")), hRect, headerFont, imgWidth);
            
            hRect.setRect(hRect.getX(), hRect.getY()-hRect.getHeight(), hRect.getWidth(), hRect.getHeight());
            Font titleFont = table.getFont().deriveFont(Font.BOLD, HEADER_FONT_SIZE - 0);
            printText(g2d, headerText.substring(headerText.indexOf("\n")), hRect, titleFont, imgWidth);
            g2d.translate(0, headerTextSpace + H_F_SPACE + hRect.getHeight());
        }
